...
class FlightEntity {
    ...
    FlightEntity(final UUID id, final String flightNumber, final String origin, final String destination,
                 final Instant departureTime, final Instant arrivalTime,
                 final int totalSeats, final int availableSeats,
                 final BigDecimal priceAmount, final String priceCurrency) {
        this.id = id;
