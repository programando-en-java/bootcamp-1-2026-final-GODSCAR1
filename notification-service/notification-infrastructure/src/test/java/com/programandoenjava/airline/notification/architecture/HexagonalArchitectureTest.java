package com.programandoenjava.airline.notification.architecture;
...
@AnalyzeClasses(
        packages = "com.programandoenjava.airline.notification",
        importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {

    private static final String DOMAIN = "..notification.domain..";
    private static final String APPLICATION = "..notification.application..";
    private static final String INFRASTRUCTURE = "..notification.infrastructure..";
    ...
    static final ArchRule domainIsFrameworkFree = noClasses()
            ...
            .should().dependOnClassesThat().resideInAnyPackage(
                    ...
                    "org.hibernate..",
                    "tools.jackson..")
            .as("notification-domain must not depend on any framework");
    ...
    static final ArchRule applicationIsFrameworkFree = noClasses()
            ...
            .should().dependOnClassesThat().resideInAnyPackage(
                    ...
                    "jakarta.persistence..",
                    "org.hibernate..")
            .as("notification-application must not depend on Spring or the persistence provider");
