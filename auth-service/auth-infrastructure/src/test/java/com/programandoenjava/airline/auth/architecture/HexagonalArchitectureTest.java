package com.programandoenjava.airline.auth.architecture;
...
@AnalyzeClasses(
        packages = "com.programandoenjava.airline.auth",
        importOptions = ImportOption.DoNotIncludeTests.class)
class HexagonalArchitectureTest {

    private static final String DOMAIN = "..auth.domain..";
    private static final String APPLICATION = "..auth.application..";
    private static final String INFRASTRUCTURE = "..auth.infrastructure..";
    ...
    static final ArchRule domainIsFrameworkFree = noClasses()
            ...
            .should().dependOnClassesThat().resideInAnyPackage(
                    ...
                    "org.hibernate..",
                    "tools.jackson..")
            .as("auth-domain must not depend on any framework");
    ...
    static final ArchRule applicationIsFrameworkFree = noClasses()
            ...
            .should().dependOnClassesThat().resideInAnyPackage(
                    ...
                    "jakarta.persistence..",
                    "org.hibernate..")
            .as("auth-application must not depend on Spring or the persistence provider");
